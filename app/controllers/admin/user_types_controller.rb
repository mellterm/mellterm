class Admin::UserTypesController < Admin::BaseController
  ...
  def create
    ...
    respond_to do |format|
      if @user_type.save
        format.html { redirect_to(admin_user_types_url, :notice => 'User Type was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @user_type.update_attributes(params[:user_type])
        format.html { redirect_to(admin_user_types_url, :notice => 'User Type was successfully updated.') }
        format.xml  { head :ok }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to(admin_user_types_url, :notice => 'User Type was deleted.') }
      format.xml  { head :ok }
    end
  end
end
